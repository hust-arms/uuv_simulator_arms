...
#include <uuv_gazebo_plugins/ArmsauvFinPlugin.hh>
...
GZ_REGISTER_MODEL_PLUGIN(gazebo::ArmsauvFinPlugin)

namespace gazebo {

/////////////////////////////////////////////////
ArmsauvFinPlugin::ArmsauvFinPlugin() : inputCommand(0), angle(0), finID(-1)
{
}

/////////////////////////////////////////////////
ArmsauvFinPlugin::~ArmsauvFinPlugin()
{
...
/////////////////////////////////////////////////
void ArmsauvFinPlugin::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
  ...
  // Front rudder factor 
  GZ_ASSERT(_sdf->HasElement("rudder_factors"), "Could not find rudder factors.");
  ...
  */
  ...
  this->currentSubscriber = this->node->Subscribe(currentVelocityTopic,
    &ArmsauvFinPlugin::UpdateCurrentVelocity, this);
  ...
  this->commandSubscriber = this->node->Subscribe(inputTopic,
                                                &ArmsauvFinPlugin::UpdateInput,
                                                this);

  // Connect the update event
  this->updateConnection = event::Events::ConnectWorldUpdateBegin(
        boost::bind(&ArmsauvFinPlugin::OnUpdate,
                    this, _1));
}

/////////////////////////////////////////////////
void ArmsauvFinPlugin::Init()
{
}

/////////////////////////////////////////////////
void ArmsauvFinPlugin::OnUpdate(const common::UpdateInfo &_info)
{
...
/////////////////////////////////////////////////
void ArmsauvFinPlugin::UpdateInput(ConstDoublePtr &_msg)
{
  this->inputCommand = _msg->value();
}

/////////////////////////////////////////////////
void ArmsauvFinPlugin::UpdateCurrentVelocity(ConstVector3dPtr &_msg)
{
