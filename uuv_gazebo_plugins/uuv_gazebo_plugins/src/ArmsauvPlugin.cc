...
#include <uuv_gazebo_plugins/ArmsauvPlugin.hh>
#include <uuv_gazebo_plugins/Def.hh>

namespace gazebo {

GZ_REGISTER_MODEL_PLUGIN(ArmsauvPlugin)

/////////////////////////////////////////////////
ArmsauvPlugin::ArmsauvPlugin() : useGlobalCurrent(true)
{
}

/////////////////////////////////////////////////
ArmsauvPlugin::~ArmsauvPlugin()
{
...
/////////////////////////////////////////////////
void ArmsauvPlugin::Load(physics::ModelPtr _model,
                                  sdf::ElementPtr _sdf)
{
  ...
  if (_sdf->HasElement("flow_velocity_topic"))
  {
    ...
    this->flowSubscriber = this->node->Subscribe(flowTopic,
      &ArmsauvPlugin::UpdateFlowVelocity, this);
  }
  ...
  if (_sdf->HasElement("link"))
  {
         ...
         linkElem = linkElem->GetNextElement("link"))
    {
      ...
      ArmsauvHydrodynamicModelPtr hydro;
      hydro.reset(
        ArmsauvHydrodynamicModelFactory::GetInstance().CreateArmsauvHydrodynamicModel(
        linkElem, link));
...
/////////////////////////////////////////////////
void ArmsauvPlugin::InitDebug(physics::LinkPtr _link,
  ArmsauvHydrodynamicModelPtr _hydro)
{
...
/////////////////////////////////////////////////
void ArmsauvPlugin::Init()
{
  // Doing nothing for now
}

/////////////////////////////////////////////////
void ArmsauvPlugin::Update(const common::UpdateInfo &_info)
{
  double time = _info.simTime.Double();

  for (std::map<gazebo::physics::LinkPtr,
       ArmsauvHydrodynamicModelPtr>::iterator it = models.begin();
       it != models.end(); ++it)
  {
    physics::LinkPtr link = it->first;
    ArmsauvHydrodynamicModelPtr hydro = it->second;
    ...
    hydro->ApplyHydrodynamicForces(time, this->flowVelocity, this->frontRudderAng, this->backRudderAng, this->vertRudderAng, this->rpm);
...
/////////////////////////////////////////////////
void ArmsauvPlugin::Connect()
{
  // Connect the update event
  this->updateConnection = event::Events::ConnectWorldUpdateBegin(
        boost::bind(&ArmsauvPlugin::Update,
                    this, _1));
}

/////////////////////////////////////////////////
void ArmsauvPlugin::PublishCurrentVelocityMarker()
{
...
/////////////////////////////////////////////////
void ArmsauvPlugin::PublishIsSubmerged()
{
  // Does nothing for now
  return;
}
...
/////////////////////////////////////////////////
void ArmsauvPlugin::UpdateFlowVelocity(ConstVector3dPtr &_msg)
{
...
/////////////////////////////////////////////////
void ArmsauvPlugin::UpdateFrontRudderAngle(ConstDoublePtr& _msg)
{
    this->frontRudderAng = _msg->value();
}

/////////////////////////////////////////////////
void ArmsauvPlugin::UpdateBackRudderAngle(ConstDoublePtr& _msg)
{
    this->backRudderAng = _msg->value();
}

/////////////////////////////////////////////////
void ArmsauvPlugin::UpdateVertRudderAngle(ConstDoublePtr& _msg)
{
    this->vertRudderAng = _msg->value();
}

/////////////////////////////////////////////////
void ArmsauvPlugin::UpdateRotorSpeed(ConstDoublePtr& _msg)
{
    this->rpm = _msg->value();
}

/////////////////////////////////////////////////
void ArmsauvPlugin::PublishRestoringForce(
...
/////////////////////////////////////////////////
void ArmsauvPlugin::PublishHydrodynamicWrenches(
  physics::LinkPtr _link)
{
  if (this->models.count(_link))
  {
...
/////////////////////////////////////////////////
void ArmsauvPlugin::GenWrenchMsg(ignition::math::Vector3d _force,
