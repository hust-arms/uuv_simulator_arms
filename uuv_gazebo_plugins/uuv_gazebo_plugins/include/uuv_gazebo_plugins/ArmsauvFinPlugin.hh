// Copyright (c) 2021 Zhao Wang - Lab arms.
// All rights reserved.
//
...
/// \file ArmsauvFinPlugin.hh
/// \brief Model plugin for description of a armsauv rudder force and torque.

#ifndef __UUV_GAZEBO_PLUGINS_ARMSAUV_FIN_PLUGIN_HH__
#define __UUV_GAZEBO_PLUGINS_ARMSAUV_FIN_PLUGIN_HH__
...
class ArmsauvFinPlugin : public ModelPlugin
{
    /// \brief Constructor
    public: ArmsauvFinPlugin();

    /// \brief Destructor
    public: virtual ~ArmsauvFinPlugin();
    ...
    //
    /// \brief Rudder factors
    protected: std::vector<double> rudderFactors;
    ...
    /// \brief Torque component calculated from the lift and drag module
    protected: ignition::math::Vector3d finTorque;
