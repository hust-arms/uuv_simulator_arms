...
/// \file ArmsauvPlugin.hh
/// \brief Class declaration for the underwater objects subject to buoyancy,
///        lift and drag forces.

#ifndef __ARMSAUV_PLUGIN_HH__
#define __ARMSAUV_PLUGIN_HH__
...
class ArmsauvPlugin : public gazebo::ModelPlugin
{
  /// \brief Constructor
  public: ArmsauvPlugin();

  /// \brief Destructor
  public: virtual ~ArmsauvPlugin();
  ...
  /// \brief Reads front rudder angle topic
  protected: void UpdateFrontRudderAngle(ConstDoublePtr& _msg);

  /// \brief Reads back rudder angle topic
  protected: void UpdateBackRudderAngle(ConstDoublePtr& _msg);

  /// \brief Reads vertical rudder angle topic
  protected: void UpdateVertRudderAngle(ConstDoublePtr& _msg);

  /// \brief Reads rotor speed topic
  protected: void UpdateRotorSpeed(ConstDoublePtr& _msg);
  ...
  protected: std::map<gazebo::physics::LinkPtr,
                      ArmsauvHydrodynamicModelPtr> models;
