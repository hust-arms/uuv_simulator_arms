...
/// \file ArmsauvROSPlugin.hh Publishes the underwater object's
/// Gazebo topics and parameters into ROS standards

#ifndef __ARMSAUV_ROS_PLUGIN_HH__
#define __ARMSAUV_ROS_PLUGIN_HH__
...
{
  class ArmsauvROSPlugin : public gazebo::ArmsauvPlugin
  {
    /// \brief Constructor
    public: ArmsauvROSPlugin();

    /// \brief Destructor
    public: virtual ~ArmsauvROSPlugin();
    ...
    public: void UpdateBackRudderAngle(const uuv_gazebo_ros_plugins_msgs::FloatStamped::ConstPtr& _msg);

    /// \brief Update the vertical rudder angle
    public: void UpdateVertRudderAngle(const uuv_gazebo_ros_plugins_msgs::FloatStamped::ConstPtr& _msg);

    /// \brief Update the front rudder angle
    public: void UpdateFrontRudderAngle(const uuv_gazebo_ros_plugins_msgs::FloatStamped::ConstPtr& _msg);

    /// \brief Update the speed of rotor
    public: void UpdateRotorSpeed(const uuv_gazebo_ros_plugins_msgs::FloatStamped::ConstPtr& _msg);
    ...
    /// \brief Subscriber to front rudder angle
    private: ros::Subscriber subFrontRudderAng;

    /// \brief Subscriber to back rudder angle
    private: ros::Subscriber subBackRudderAng;

    /// \brief Subscriber to vertical rudder angle
    private: ros::Subscriber subVertRudderAng;

    /// \brief Subscriber to speed of rotor
    private: ros::Subscriber subRotorSpeed;

    /// \brief Front rudder angle
    private: double frontRudderAng;

    /// \brief Back rudder angle
    private: double backRudderAng;

    /// \brief Vertical rudder angle
    private: double vertRudderAng;
