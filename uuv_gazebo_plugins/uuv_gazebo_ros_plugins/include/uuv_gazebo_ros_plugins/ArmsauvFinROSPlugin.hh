...
#ifndef __ARMSAUV_FIN_ROS_PLUGIN_HH__
#define __ARMSAUV_FIN_ROS_PLUGIN_HH__
...
{
  class ArmsauvFinROSPlugin : public gazebo::ArmsauvFinPlugin
  {
    /// \brief Constrcutor.
    public: ArmsauvFinROSPlugin();
