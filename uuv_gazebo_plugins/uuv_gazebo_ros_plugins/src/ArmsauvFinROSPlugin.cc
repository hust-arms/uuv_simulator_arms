// Copyright (c) 2021 Zhao Wang - Lab HUST-Arms.
// All rights reserved.
//
...
#include <uuv_gazebo_ros_plugins/ArmsauvFinROSPlugin.hh>
...
{
/////////////////////////////////////////////////
ArmsauvFinROSPlugin::ArmsauvFinROSPlugin()
{
...
/////////////////////////////////////////////////
void ArmsauvFinROSPlugin::SetReference(
    const uuv_gazebo_ros_plugins_msgs::FloatStamped::ConstPtr &_msg)
{
  if (std::isnan(_msg->data))
  {
    ROS_WARN("ArmsauvFinROSPlugin: Ignoring nan command");
    return;
  }
...
/////////////////////////////////////////////////
gazebo::common::Time ArmsauvFinROSPlugin::GetRosPublishPeriod()
{
  return this->rosPublishPeriod;
}

/////////////////////////////////////////////////
void ArmsauvFinROSPlugin::SetRosPublishRate(double _hz)
{
  if (_hz > 0.0)
...
/////////////////////////////////////////////////
void ArmsauvFinROSPlugin::Init()
{
  FinPlugin::Init();
}

/////////////////////////////////////////////////
void ArmsauvFinROSPlugin::Reset()
{
  this->lastRosPublishTime.Set(0, 0);
}

/////////////////////////////////////////////////
void ArmsauvFinROSPlugin::Load(gazebo::physics::ModelPtr _parent, sdf::ElementPtr _sdf)
{
  try {
  ...
  this->subReference = this->rosNode->subscribe<
    ...
    >(this->commandSubscriber->GetTopic(), 10,
      boost::bind(&ArmsauvFinROSPlugin::SetReference, this, _1));
  ...
  this->services["get_lift_drag_params"] = this->rosNode->advertiseService(
    stream.str(), &ArmsauvFinROSPlugin::GetLiftDragParams, this);
  ...
  this->rosPublishConnection = gazebo::event::Events::ConnectWorldUpdateBegin(
        boost::bind(&ArmsauvFinROSPlugin::RosPublishStates, this));
}

/////////////////////////////////////////////////
void ArmsauvFinROSPlugin::RosPublishStates()
{
      ...
      this->rosPublishPeriod)
  {
    ...
    msg.Wrench.torque.x = this->finTorque.X();
    msg.Wrench.torque.y = this->finTorque.Y();
    msg.Wrench.torque.z = this->finTorque.Z();
...
/////////////////////////////////////////////////
/*
bool ArmsauvFinROSPlugin::GetLiftDragParams(
...
GZ_REGISTER_MODEL_PLUGIN(ArmsauvFinROSPlugin)
}
